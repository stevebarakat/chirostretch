...
export default async function FranchiseeStaffPage() {
  ...
  if (!authenticated) {
    redirect("/login?redirect=/my-account/franchisee/staff");
  }
  ...
  if (!viewer) {
    return (
      <FranchiseeDashboardLayout title="Staff Management">
  ...
  return (
    <FranchiseeDashboardLayout title="Staff Management">
      <div className={styles.header}>
        ...
        <Link href="/my-account/franchisee/staff/new" className={styles.addButton}>
          + Add Staff Member
        </Link>
      </div>

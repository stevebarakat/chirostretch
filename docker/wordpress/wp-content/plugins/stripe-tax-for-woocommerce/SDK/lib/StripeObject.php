...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable {
	...
	public function &__get( $k ) {
		...
		if ( ! empty( $this->_transientValues ) && $this->_transientValues->includes( $k ) ) {
			...
			$message = "Stripe\StripeTaxForWooCommerce\SDK\lib Notice: Undefined property of {$class} instance: {$k}. "
					. "HINT: The {$k} attribute was set in the past, however. "
					. 'It was then wiped when refreshing the object '
					. "with the result returned by Stripe\StripeTaxForWooCommerce\SDK\lib's API, "
		...
		$class = static::class;
		Stripe::getLogger()->error( "Stripe\StripeTaxForWooCommerce\SDK\lib Notice: Undefined property of {$class} instance: {$k}" );
	 ...
	 * Stripe\StripeTaxForWooCommerce\SDK\lib object.
	 *
	...
	/**
	 * Returns a pretty JSON representation of the Stripe\StripeTaxForWooCommerce\SDK\lib object.
	 *
	 * @return string the JSON representation of the Stripe\StripeTaxForWooCommerce\SDK\lib object
	 */
	...
	/**
	 * @return null|ApiResponse The last response from the Stripe\StripeTaxForWooCommerce\SDK\lib API
	 */
	...
	/**
	 * Sets the last response from the Stripe\StripeTaxForWooCommerce\SDK\lib API.
	 *

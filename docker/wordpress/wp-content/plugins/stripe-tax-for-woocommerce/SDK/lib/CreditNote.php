 ...
 * @property string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Customer $customer ID of the customer.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\CustomerBalanceTransaction $customer_balance_transaction Customer balance transaction related to this credit note.
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject[] $discount_amounts The aggregate amounts calculated per discount for all line items.
 ...
 * @property string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Invoice $invoice ID of the invoice.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\CreditNoteLineItem> $lines Line items that make up the credit note
 ...
 * @property null|int $out_of_band_amount Amount that was credited outside of Stripe\StripeTaxForWooCommerce\SDK\lib.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Refund $refund Refund related to this credit note.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $shipping_cost The details of the cost of shipping, including the ShippingRate applied to the invoice.
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject[] $tax_amounts The aggregate amounts calculated per tax rate for all line items.
...
class CreditNote extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\CreditNote the previewed credit note
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\CreditNoteLineItem> list of credit note line items
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\CreditNote the voided credit note
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\CreditNoteLineItem> the list of credit note line items
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $action The most recent action performed by the reader.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Terminal\Location $location The location identifier of the reader.
 ...
 */
class Reader extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Terminal\Reader the canceled reader
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Terminal\Reader the processed reader
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Terminal\Reader the refunded reader
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Terminal\Reader the seted reader
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

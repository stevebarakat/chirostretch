...
/**
 * A <code>Payout</code> object is created when you receive funds from Stripe\StripeTaxForWooCommerce\SDK\lib, or when you
 * initiate a payout to either a bank account or debit card of a <a href="/docs/connect/bank-debit-card-payouts">connected
 * Stripe\StripeTaxForWooCommerce\SDK\lib account</a>. You can retrieve individual payouts,
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this payout on your account balance.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\BankAccount|\Stripe\StripeTaxForWooCommerce\SDK\lib\Card $destination ID of the bank account or card the payout is sent to.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\BalanceTransaction $failure_balance_transaction If the payout fails or cancels, this is the ID of the balance transaction that reverses the initial balance transaction and returns the funds from the failed payout back in your balance.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Payout $original_payout If the payout reverses another, this is the ID of the original payout.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Payout $reversed_by If the payout reverses, this is the ID of the payout that reverses this payout.
...
class Payout extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Payout the canceled payout
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Payout the reversed payout
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

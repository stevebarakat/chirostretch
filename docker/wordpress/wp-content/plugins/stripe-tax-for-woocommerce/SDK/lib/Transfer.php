...
/**
 * A <code>Transfer</code> object is created when you move funds between Stripe\StripeTaxForWooCommerce\SDK\lib accounts as
 * part of Connect.
 *
 * Before April 6, 2017, transfers also represented movement of funds from a
 * Stripe\StripeTaxForWooCommerce\SDK\lib account to a card or bank account. This behavior has since been split
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\BalanceTransaction $balance_transaction Balance transaction that describes the impact of this transfer on your account balance.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Account $destination ID of the Stripe\StripeTaxForWooCommerce\SDK\lib account the transfer was sent to.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Charge $destination_payment If the destination is a Stripe\StripeTaxForWooCommerce\SDK\lib account, this will be the ID of the payment that the destination account received for the transfer.
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\TransferReversal> $reversals A list of reversals that have been applied to the transfer.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Charge $source_transaction ID of the charge or payment that was used to fund the transfer. If null, the transfer was funded from the available balance.
...
class Transfer extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\TransferReversal> the list of transfer reversals
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\TransferReversal
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

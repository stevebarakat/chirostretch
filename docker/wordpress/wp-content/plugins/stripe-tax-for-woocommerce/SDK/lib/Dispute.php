 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\BalanceTransaction[] $balance_transactions List of zero, one, or two balance transactions that show funds withdrawn and reinstated to your Stripe\StripeTaxForWooCommerce\SDK\lib account as a result of this dispute.
 * @property string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Charge $charge ID of the charge that's disputed.
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $evidence_details
 * @property bool $is_charge_refundable If true, it's still possible to refund the disputed payment. After the payment has been fully refunded, no further funds are withdrawn from your Stripe\StripeTaxForWooCommerce\SDK\lib account as a result of this dispute.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent $payment_intent ID of the PaymentIntent that's disputed.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $payment_method_details
...
class Dispute extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Dispute the closed dispute

...
class ApiRequestor {
	...
	private static $OPTIONS_KEYS = array( 'api_key', 'idempotency_key', 'stripe_account', 'stripe_version', 'api_base' );
	 ...
	 */
	public function request( $method, $url, $params = null, $headers = null, $usage = array() ) {
		$params                                    = $params ?: array();
	 ...
	 * @throws Exception\ApiErrorException
	 */
	public function requestStream( $method, $url, $readBodyChunkCallable, $params = null, $headers = null, $usage = array() ) {
		$params                                    = $params ?: array();
		$headers                                   = $headers ?: array();
		list($rbody, $rcode, $rheaders, $myApiKey) =
	...
	private function _prepareRequest( $method, $url, $params, $headers ) {
		...
		return array( $absUrl, $rawHeaders, $params, $hasFile, $myApiKey );
	}

...
/**
 * The <code>Charge</code> object represents a single attempt to move money into your Stripe\StripeTaxForWooCommerce\SDK\lib account.
 * PaymentIntent confirmation is the most common way to create Charges, but transferring
 * money to a different Stripe\StripeTaxForWooCommerce\SDK\lib account through Connect also creates Charges.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $application ID of the Connect application that created the charge.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\ApplicationFee $application_fee The application fee (if any) for the charge. <a href="https://stripe.com/docs/connect/direct-charges#collecting-fees">See the Connect documentation</a> for details.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this charge on your account balance (not including refunds or disputes).
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Customer $customer ID of the customer this charge is for if one exists.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property bool $disputed Whether the charge has been disputed.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\BalanceTransaction $failure_balance_transaction ID of the balance transaction that describes the reversal of the balance on your account due to payment failure.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $fraud_details Information on fraud assessments for the charge.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Invoice $invoice ID of the invoice this charge is for if one exists.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $level3
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Account $on_behalf_of The account (if any) the charge was made on behalf of without triggering an automatic transfer. See the <a href="https://stripe.com/docs/connect/separate-charges-and-transfers">Connect documentation</a> for details.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $outcome Details about whether the payment was accepted, and why. See <a href="https://stripe.com/docs/declines">understanding declines</a> for details.
 * @property bool $paid <code>true</code> if the charge succeeded, or was successfully authorized for later capture.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent $payment_intent ID of the PaymentIntent associated with this charge, if one exists.
 * @property null|string $payment_method ID of the payment method used in this charge.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $payment_method_details Details about the payment method at the time of the transaction.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\Refund> $refunds A list of refunds that have been applied to the charge.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Review $review ID of the review associated with this charge if one exists.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $shipping Shipping information for the charge.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\Account|\Stripe\StripeTaxForWooCommerce\SDK\lib\BankAccount|\Stripe\StripeTaxForWooCommerce\SDK\lib\Card|\Stripe\StripeTaxForWooCommerce\SDK\lib\Source $source This is a legacy field that will be removed in the future. It contains the Source, Card, or BankAccount object used for the charge. For details about the payment method used for this charge, refer to <code>payment_method</code> or <code>payment_method_details</code> instead.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Transfer $source_transfer The transfer ID which created this charge. Only present if the charge came from another Stripe\StripeTaxForWooCommerce\SDK\lib account. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Transfer $transfer ID of the transfer to the <code>destination</code> account (only applicable if the charge was created using the <code>destination</code> parameter).
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $transfer_data An optional dictionary including the account to automatically transfer to as part of a destination charge. <a href="https://stripe.com/docs/connect/destination-charges">See the Connect documentation</a> for details.
...
class Charge extends ApiResource {
	 ...
	 * These strings are applicable to the decline_code property of the \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\CardException exception.
	 *
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Charge the captured charge
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SearchResult<\Stripe\StripeTaxForWooCommerce\SDK\lib\Charge> the charge search results
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

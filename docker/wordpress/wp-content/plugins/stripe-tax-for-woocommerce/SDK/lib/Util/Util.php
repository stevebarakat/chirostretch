...
use Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject;
...
abstract class Util {
	...
	/**
	 * Converts a response from the Stripe\StripeTaxForWooCommerce\SDK\lib API to the corresponding PHP object.
	 *
	 * @param array $resp the response from the Stripe\StripeTaxForWooCommerce\SDK\lib API
	 * @param array $opts
	 *
	 * @return array|StripeObject
	 */
	public static function convertToStripeObject( $resp, $opts ) {
		$types = \Stripe\StripeTaxForWooCommerce\SDK\lib\Util\ObjectTypes::mapping;
		if ( self::isList( $resp ) ) {
			$mapped = array();
			foreach ( $resp as $i ) {
		...
		if ( \is_array( $resp ) ) {
			if ( isset( $resp['object'] ) && \is_string( $resp['object'] ) && isset( $types[ $resp['object'] ] ) ) {
				...
				$class = \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject::class;
			}
	...
	public static function objectsToIds( $h ) {
		if ( $h instanceof \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource ) {
			return $h->id;
		}
		if ( static::isList( $h ) ) {
			$results = array();

...
class RequestOptions {
	...
	public static $HEADERS_TO_PERSIST = array(
		'Stripe\StripeTaxForWooCommerce\SDK\lib-Account',
		'Stripe\StripeTaxForWooCommerce\SDK\lib-Version',
	);
	...
	public static function parse( $options, $strict = false ) {
		...
		if ( \is_array( $options ) ) {
			...
			if ( \array_key_exists( 'stripe_account', $options ) ) {
				$headers['Stripe\StripeTaxForWooCommerce\SDK\lib-Account'] = $options['stripe_account'];
				unset( $options['stripe_account'] );
			}
			if ( \array_key_exists( 'stripe_version', $options ) ) {
				$headers['Stripe\StripeTaxForWooCommerce\SDK\lib-Version'] = $options['stripe_version'];
		...
		$message = 'The second argument to Stripe\StripeTaxForWooCommerce\SDK\lib API method calls is an '
			. 'optional per-request apiKey, which must be a string, or '
			. 'per-request options, which must be an array. (HINT: you can set '
			. 'a global apiKey by "Stripe\StripeTaxForWooCommerce\SDK\lib::setApiKey(<apiKey>)")';

...
class DefaultLogger implements LoggerInterface {
	...
	public function error( $message, array $context = array() ) {
		if ( \count( $context ) > 0 ) {
			throw new \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\BadMethodCallException( 'DefaultLogger does not currently implement context. Please implement if you need it.' );
		}

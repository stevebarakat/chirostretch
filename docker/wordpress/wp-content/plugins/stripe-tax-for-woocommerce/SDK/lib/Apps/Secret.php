...
namespace Stripe\StripeTaxForWooCommerce\SDK\lib\Apps;

/**
 * Secret Store is an API that allows Stripe\StripeTaxForWooCommerce\SDK\lib Apps developers to securely persist secrets for use by UI Extensions and app backends.
 *
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $scope
 */
class Secret extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Apps\Secret the deleted secret
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Apps\Secret the finded secret
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

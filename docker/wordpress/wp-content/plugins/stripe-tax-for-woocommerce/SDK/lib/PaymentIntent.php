 ...
 * throughout its lifetime as it interfaces with Stripe\StripeTaxForWooCommerce\SDK\lib.js to perform
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $amount_details
 * @property int $amount_received Amount that this PaymentIntent collects.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $application ID of the Connect application that created the PaymentIntent.
 * @property null|int $application_fee_amount The amount of the application fee (if any) that will be requested to be applied to the payment and transferred to the application owner's Stripe\StripeTaxForWooCommerce\SDK\lib account. The amount of the application fee collected will be capped at the total payment amount. For more information, see the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a>.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $automatic_payment_methods Settings to configure compatible payment methods from the <a href="https://dashboard.stripe.com/settings/payment_methods">Stripe\StripeTaxForWooCommerce\SDK\lib Dashboard</a>
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Customer $customer <p>ID of the Customer this PaymentIntent belongs to, if one exists.</p><p>Payment methods attached to other Customers cannot be used with this PaymentIntent.</p><p>If present in combination with <a href="https://stripe.com/docs/api#payment_intent_object-setup_future_usage">setup_future_usage</a>, this PaymentIntent's payment method will be attached to the Customer after the PaymentIntent has been confirmed and any required actions from the user are complete.</p>
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Invoice $invoice ID of the invoice that created this PaymentIntent, if it exists.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $last_payment_error The payment error encountered in the previous PaymentIntent confirmation. It will be cleared if the PaymentIntent is later updated for any reason.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Charge $latest_charge The latest charge created by this PaymentIntent.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to fulfill a payment using the provided source.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Account $on_behalf_of The account (if any) for which the funds of the PaymentIntent are intended. See the PaymentIntents <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a> for details.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentMethod $payment_method ID of the payment method used in this PaymentIntent.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this PaymentIntent.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $payment_method_options Payment-method-specific configuration for this PaymentIntent.
 * @property string[] $payment_method_types The list of payment method types (e.g. card) that this PaymentIntent is allowed to use.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $processing If present, this property tells you about the processing state of the payment.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Review $review ID of the review associated with this PaymentIntent, if any.
 * @property null|string $setup_future_usage <p>Indicates that you intend to make future payments with this PaymentIntent's payment method.</p><p>Providing this parameter will <a href="https://stripe.com/docs/payments/save-during-payment">attach the payment method</a> to the PaymentIntent's Customer, if present, after the PaymentIntent is confirmed and any required actions from the user are complete. If no Customer was provided, the payment method can still be <a href="https://stripe.com/docs/api/payment_methods/attach">attached</a> to a Customer after the transaction completes.</p><p>When processing card payments, Stripe\StripeTaxForWooCommerce\SDK\lib also uses <code>setup_future_usage</code> to dynamically optimize your payment flow and comply with regional legislation and network rules, such as <a href="https://stripe.com/docs/strong-customer-authentication">SCA</a>.</p>
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $shipping Shipping information for this PaymentIntent.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Account|\Stripe\StripeTaxForWooCommerce\SDK\lib\BankAccount|\Stripe\StripeTaxForWooCommerce\SDK\lib\Card|\Stripe\StripeTaxForWooCommerce\SDK\lib\Source $source This is a legacy field that will be removed in the future. It is the ID of the Source object that is associated with this PaymentIntent, if one was supplied.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $transfer_data The data that automatically creates a Transfer after the payment finalizes. Learn more about the <a href="https://stripe.com/docs/payments/connected-accounts">use case for connected accounts</a>.
...
class PaymentIntent extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent the applied payment intent
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent the canceled payment intent
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent the captured payment intent
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent the confirmed payment intent
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent the incremented payment intent
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent the verified payment intent
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SearchResult<\Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent> the payment intent search results
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

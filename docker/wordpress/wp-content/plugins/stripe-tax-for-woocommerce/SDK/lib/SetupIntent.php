 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $application ID of the Connect application that created the SetupIntent.
 * @property null|bool $attach_to_self <p>If present, the SetupIntent's payment method will be attached to the in-context Stripe\StripeTaxForWooCommerce\SDK\lib Account.</p><p>It can only be used for this Stripe\StripeTaxForWooCommerce\SDK\lib Account’s own money movement flows like InboundTransfer and OutboundTransfers. It cannot be set to true when setting up a PaymentMethod for a Customer, and defaults to false when attaching a PaymentMethod to a Customer.</p>
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $automatic_payment_methods Settings for dynamic payment methods compatible with this Setup Intent
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Customer $customer <p>ID of the Customer this SetupIntent belongs to, if one exists.</p><p>If present, the SetupIntent's payment method will be attached to the Customer on successful setup. Payment methods attached to other Customers cannot be used with this SetupIntent.</p>
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $last_setup_error The error encountered in the previous SetupIntent confirmation.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\SetupAttempt $latest_attempt The most recent SetupAttempt for this SetupIntent.
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Mandate $mandate ID of the multi use Mandate generated by the SetupIntent.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $next_action If present, this property tells you what actions you need to take in order for your customer to continue payment setup.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Account $on_behalf_of The account (if any) for which the setup is intended.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentMethod $payment_method ID of the payment method used with this SetupIntent.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this Setup Intent.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $payment_method_options Payment method-specific configuration for this SetupIntent.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Mandate $single_use_mandate ID of the single_use Mandate generated by the SetupIntent.
...
class SetupIntent extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SetupIntent the canceled setup intent
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SetupIntent the confirmed setup intent
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SetupIntent the verified setup intent
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $application ID of the Connect Application that created the schedule.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $current_phase Object representing the start and end dates for the current phase of the subscription schedule, if it is <code>active</code>.
 * @property string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Customer $customer ID of the customer who owns the subscription schedule.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $default_settings
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject[] $phases Configuration for the subscription schedule's phases.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Subscription $subscription ID of the subscription managed by the subscription schedule.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\TestHelpers\TestClock $test_clock ID of the test clock this subscription schedule belongs to.
 */
class SubscriptionSchedule extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SubscriptionSchedule the canceled subscription schedule
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SubscriptionSchedule the released subscription schedule
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

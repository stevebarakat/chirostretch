...
namespace Stripe\StripeTaxForWooCommerce\SDK\lib\Identity;
 ...
 * @property null|string $client_secret The short-lived client secret used by Stripe\StripeTaxForWooCommerce\SDK\lib.js to <a href="https://stripe.com/docs/js/identity/modal">show a verification modal</a> inside your app. This client secret expires after 24 hours and can only be used once. Don’t store it, log it, embed it in a URL, or expose it to anyone other than the user. Make sure that you have TLS enabled on any page that includes the client secret. Refer to our docs on <a href="https://stripe.com/docs/identity/verification-sessions#client-secret">passing the client secret to the frontend</a> to learn more.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $last_error If present, this property tells you the last error encountered when processing the verification.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Identity\VerificationReport $last_verification_report ID of the most recent VerificationReport. <a href="https://stripe.com/docs/identity/verification-sessions#results">Learn more about accessing detailed verification results.</a>
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $options A set of options for the session’s verification checks.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $redaction Redaction status of this VerificationSession. If the VerificationSession is not redacted, this field will be null.
 ...
 * @property null|string $url The short-lived URL that you use to redirect a user to Stripe\StripeTaxForWooCommerce\SDK\lib to submit their identity information. This URL expires after 48 hours and can only be used once. Don’t store it, log it, send it in emails or expose it to anyone other than the user. Refer to our docs on <a href="https://stripe.com/docs/identity/verify-identity-documents?platform=web&amp;type=redirect">verifying identity documents</a> to learn how to redirect users to Stripe\StripeTaxForWooCommerce\SDK\lib.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $verified_outputs The user’s verified data.
 */
class VerificationSession extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Identity\VerificationSession the canceled verification session
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Identity\VerificationSession the redacted verification session
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

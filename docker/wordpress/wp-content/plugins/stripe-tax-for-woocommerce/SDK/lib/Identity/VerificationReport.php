 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $document Result from a document check
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $id_number Result from an id_number check
 * @property bool $livemode Has the value <code>true</code> if the object exists in live mode or the value <code>false</code> if the object exists in test mode.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $options
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $selfie Result from a selfie check
 ...
 */
class VerificationReport extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {

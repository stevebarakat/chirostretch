...
/**
 * Balance transactions represent funds moving through your Stripe\StripeTaxForWooCommerce\SDK\lib account.
 * Stripe\StripeTaxForWooCommerce\SDK\lib creates them for every type of transaction that enters or leaves your Stripe\StripeTaxForWooCommerce\SDK\lib account balance.
 *
 ...
 * @property int $available_on The date that the transaction's net funds become available in the Stripe\StripeTaxForWooCommerce\SDK\lib balance.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|float $exchange_rate If applicable, this transaction uses an exchange rate. If money converts from currency A to currency B, then the <code>amount</code> in currency A, multipled by the <code>exchange_rate</code>, equals the <code>amount</code> in currency B. For example, if you charge a customer 10.00 EUR, the PaymentIntent's <code>amount</code> is <code>1000</code> and <code>currency</code> is <code>eur</code>. If this converts to 12.34 USD in your Stripe\StripeTaxForWooCommerce\SDK\lib account, the BalanceTransaction's <code>amount</code> is <code>1234</code>, its <code>currency</code> is <code>usd</code>, and the <code>exchange_rate</code> is <code>1.234</code>.
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject[] $fee_details Detailed breakdown of fees (in cents (or local equivalent)) paid for this transaction.
 * @property int $net Net impact to a Stripe\StripeTaxForWooCommerce\SDK\lib balance (in cents (or local equivalent)). A positive value represents incrementing a Stripe\StripeTaxForWooCommerce\SDK\lib balance, and a negative value decrementing a Stripe\StripeTaxForWooCommerce\SDK\lib balance. You can calculate the net impact of a transaction on a balance by <code>amount</code> - <code>fee</code>
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\ApplicationFee|\Stripe\StripeTaxForWooCommerce\SDK\lib\ApplicationFeeRefund|\Stripe\StripeTaxForWooCommerce\SDK\lib\Charge|\Stripe\StripeTaxForWooCommerce\SDK\lib\CustomerCashBalanceTransaction|\Stripe\StripeTaxForWooCommerce\SDK\lib\Dispute|\Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Authorization|\Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Dispute|\Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Transaction|\Stripe\StripeTaxForWooCommerce\SDK\lib\Payout|\Stripe\StripeTaxForWooCommerce\SDK\lib\Refund|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject|\Stripe\StripeTaxForWooCommerce\SDK\lib\Topup|\Stripe\StripeTaxForWooCommerce\SDK\lib\Transfer|\Stripe\StripeTaxForWooCommerce\SDK\lib\TransferReversal $source This transaction relates to the Stripe\StripeTaxForWooCommerce\SDK\lib object.
 * @property string $status The transaction's net funds status in the Stripe\StripeTaxForWooCommerce\SDK\lib balance, which are either <code>available</code> or <code>pending</code>.

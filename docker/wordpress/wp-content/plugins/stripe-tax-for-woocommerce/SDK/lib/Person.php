...
/**
 * This is an object representing a person associated with a Stripe\StripeTaxForWooCommerce\SDK\lib account.
 *
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $additional_tos_acceptances
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $address
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $address_kana The Kana variation of the person's address (Japan only).
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $address_kanji The Kanji variation of the person's address (Japan only).
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $dob
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for this person</a>, including what information needs to be collected, and by when.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $registered_address
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $relationship
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $requirements Information about the requirements for this person, including what information needs to be collected, and by when.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $verification
 */
class Person extends ApiResource {
	...
	/**
	 * @return string the API URL for this Stripe\StripeTaxForWooCommerce\SDK\lib account reversal
	 */
	 ...
	 *
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\BadMethodCallException
	 */

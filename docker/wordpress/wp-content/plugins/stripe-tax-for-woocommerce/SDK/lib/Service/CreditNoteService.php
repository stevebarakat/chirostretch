...
class CreditNoteService extends \Stripe\StripeTaxForWooCommerce\SDK\lib\Service\AbstractService {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\CreditNote>
	 ...
	 * @param null|array|\Stripe\StripeTaxForWooCommerce\SDK\lib\Util\RequestOptions $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\CreditNoteLineItem>
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * <li>Outside of Stripe\StripeTaxForWooCommerce\SDK\lib credit: record the amount that is or will be credited
	 * outside of Stripe\StripeTaxForWooCommerce\SDK\lib (using <code>out_of_band_amount</code>).</li> </ul>
	 *
	 * For post-payment credit notes the sum of the refund, credit and outside of
	 * Stripe\StripeTaxForWooCommerce\SDK\lib amounts must equal the credit note total.
	 *
	 ...
	 * @param null|array|\Stripe\StripeTaxForWooCommerce\SDK\lib\Util\RequestOptions $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\CreditNote
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

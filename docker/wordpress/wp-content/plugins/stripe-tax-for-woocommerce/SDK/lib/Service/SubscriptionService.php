...
class SubscriptionService extends \Stripe\StripeTaxForWooCommerce\SDK\lib\Service\AbstractService {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\Subscription>
	 ...
	 *
	 * By default, upon subscription cancellation, Stripe\StripeTaxForWooCommerce\SDK\lib will stop automatic
	 ...
	 * @param null|array|\Stripe\StripeTaxForWooCommerce\SDK\lib\Util\RequestOptions $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Subscription
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	...
	/**
	 * Search for subscriptions you’ve previously created using Stripe\StripeTaxForWooCommerce\SDK\lib’s <a
	 ...
	 * @param null|array|\Stripe\StripeTaxForWooCommerce\SDK\lib\Util\RequestOptions $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SearchResult<\Stripe\StripeTaxForWooCommerce\SDK\lib\Subscription>
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

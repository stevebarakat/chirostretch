...
class SubscriptionItemService extends \Stripe\StripeTaxForWooCommerce\SDK\lib\Service\AbstractService {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\SubscriptionItem>
	 ...
	 * @param null|array|\Stripe\StripeTaxForWooCommerce\SDK\lib\Util\RequestOptions $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\UsageRecordSummary>
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|\Stripe\StripeTaxForWooCommerce\SDK\lib\Util\RequestOptions $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SubscriptionItem
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * with a quantity.
	 *
	 * Usage records provide <code>quantity</code> information that Stripe\StripeTaxForWooCommerce\SDK\lib uses to
	 ...
	 * billing</a> plan, Stripe\StripeTaxForWooCommerce\SDK\lib helps you send accurate invoices to your customers.
	 *
	 ...
	 * there is more than one usage record with the same timestamp, Stripe\StripeTaxForWooCommerce\SDK\lib adds the

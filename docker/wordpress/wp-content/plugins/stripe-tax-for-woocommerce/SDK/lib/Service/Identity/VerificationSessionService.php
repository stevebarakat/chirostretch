...
class VerificationSessionService extends \Stripe\StripeTaxForWooCommerce\SDK\lib\Service\AbstractService {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\Identity\VerificationSession>
	 ...
	 * @param null|array|\Stripe\StripeTaxForWooCommerce\SDK\lib\Util\RequestOptions $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Identity\VerificationSession
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	...
	/**
	 * Redact a VerificationSession to remove all collected information from Stripe\StripeTaxForWooCommerce\SDK\lib.
	 ...
	 *
	 * Redaction is irreversible. Redacted objects are still accessible in the Stripe\StripeTaxForWooCommerce\SDK\lib

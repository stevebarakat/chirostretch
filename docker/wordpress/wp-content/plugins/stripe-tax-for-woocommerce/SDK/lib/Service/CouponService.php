...
class CouponService extends \Stripe\StripeTaxForWooCommerce\SDK\lib\Service\AbstractService {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\Coupon>
	 ...
	 * Stripe\StripeTaxForWooCommerce\SDK\lib dashboard. Coupon creation is also accessible via the API if you need to
	 ...
	 * @param null|array|\Stripe\StripeTaxForWooCommerce\SDK\lib\Util\RequestOptions $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Coupon
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * href="https://dashboard.stripe.com/coupons">coupon management</a> page of the
	 * Stripe\StripeTaxForWooCommerce\SDK\lib dashboard. However, deleting a coupon does not affect any customers who

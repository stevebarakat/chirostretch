 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $destination_payment_method_details Details about the PaymentMethod for an OutboundPayment.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $end_user_details Details about the end user.
 ...
 * @property null|string $hosted_regulatory_receipt_url A <a href="https://stripe.com/docs/treasury/moving-money/regulatory-receipts">hosted transaction receipt</a> URL that is provided when money movement is considered regulated under Stripe\StripeTaxForWooCommerce\SDK\lib's money transmission licenses.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $returned_details Details about a returned OutboundPayment. Only set when the status is <code>returned</code>.
 ...
 * @property string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Treasury\Transaction $transaction The Transaction associated with this object.
 */
class OutboundPayment extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Treasury\OutboundPayment the canceled outbound payment

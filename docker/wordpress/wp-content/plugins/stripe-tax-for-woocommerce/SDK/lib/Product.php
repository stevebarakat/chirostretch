 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Price $default_price The ID of the <a href="https://stripe.com/docs/api/prices">Price</a> object that is the default price for this product.
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject[] $features A list of up to 15 features for this product. These are displayed in <a href="https://stripe.com/docs/payments/checkout/pricing-table">pricing tables</a>.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $package_dimensions The dimensions of this product for shipping purposes.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\TaxCode $tax_code A <a href="https://stripe.com/docs/tax/tax-categories">tax code</a> ID.
...
class Product extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\SearchResult<\Stripe\StripeTaxForWooCommerce\SDK\lib\Product> the product search results

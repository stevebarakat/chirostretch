...
/**
 * An issuing token object is created when an issued card is added to a digital wallet. As a <a href="https://stripe.com/docs/issuing">card issuer</a>, you can <a href="https://stripe.com/docs/issuing/controls/token-management">view and manage these tokens</a> through Stripe\StripeTaxForWooCommerce\SDK\lib.
 *
 * @property string $id Unique identifier for the object.
 * @property string $object String representing the object's type. Objects of the same type share the same value.
 * @property string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Card $card Card associated with this token.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $network_data
 ...
 */
class Token extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {

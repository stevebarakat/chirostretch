 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Card $replaced_by The latest card that replaces this card, if any.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Card $replacement_for The card this card replaces, if any.
 * @property null|string $replacement_reason The reason why the previous card needed to be replaced.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $shipping Where and how the card will be shipped.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $spending_controls
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $wallets Information relating to digital wallets (like Apple Pay and Google Pay).
 */
class Card extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {

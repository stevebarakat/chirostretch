 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\BalanceTransaction[] $balance_transactions List of balance transactions associated with this authorization.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Card $card You can <a href="https://stripe.com/docs/issuing/cards">create physical or virtual cards</a> that are issued to cardholders.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Cardholder $cardholder The cardholder to whom this authorization belongs.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $network_data Details about the authorization, such as identifiers, set by the card network.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $pending_request The pending authorization request. This field will only be non-null during an <code>issuing_authorization.request</code> webhook.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject[] $request_history History of every time a <code>pending_request</code> authorization was approved/declined, either by you directly or by Stripe\StripeTaxForWooCommerce\SDK\lib (e.g. based on your spending_controls). If the merchant changes the authorization by performing an incremental authorization, you can look at this field to see the previous requests for the authorization. This field can be helpful in determining why a given authorization was approved/declined.
 * @property string $status The current status of the authorization in its lifecycle.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Token $token <a href="https://stripe.com/docs/api/issuing/tokens/object">Token</a> object used for this authorization. If a network token was not used for this authorization, this field will be null.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Transaction[] $transactions List of <a href="https://stripe.com/docs/api/issuing/transactions">transactions</a> associated with this authorization.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $treasury <a href="https://stripe.com/docs/api/treasury">Treasury</a> details related to this authorization if it was created on a <a href="https://stripe.com/docs/api/treasury/financial_accounts">FinancialAccount</a>.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $verification_data
 ...
 */
class Authorization extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Authorization the approved authorization
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Issuing\Authorization the declined authorization
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

 ...
 * represent a customer's payment instrument, and can be used with the Stripe\StripeTaxForWooCommerce\SDK\lib API
 * just like a <code>Card</code> object: once chargeable, they can be charged, or can be
 * attached to customers.
 *
 * Stripe\StripeTaxForWooCommerce\SDK\lib doesn't recommend using the deprecated <a href="https://stripe.com/docs/api/sources">Sources API</a>.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $ach_credit_transfer
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $ach_debit
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $code_verification
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $owner Information about the owner of the payment instrument that may be used or required by particular source types.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $p24
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $receiver
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $redirect
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $sepa_credit_transfer
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $source_order
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $three_d_secure
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $wechat
 */
class Source extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Source the detached source
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 *
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\UnexpectedValueException if the source is not attached to a customer
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\SourceTransaction> list of source transactions
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Source the verified source
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

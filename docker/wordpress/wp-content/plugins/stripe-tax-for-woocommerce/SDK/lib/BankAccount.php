 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Account $account The ID of the account that the bank account is associated with.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Customer $customer The ID of the customer that the bank account is associated with.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $future_requirements Information about the <a href="https://stripe.com/docs/connect/custom-accounts/future-requirements">upcoming new requirements for the bank account</a>, including what information needs to be collected, and by when.

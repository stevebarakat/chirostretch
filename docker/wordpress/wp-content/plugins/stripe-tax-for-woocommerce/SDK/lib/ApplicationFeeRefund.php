 ...
 * the Stripe\StripeTaxForWooCommerce\SDK\lib account from which the fee was originally collected.
 *
 ...
 * @property string|\Stripe\StripeTaxForWooCommerce\SDK\lib\ApplicationFee $fee ID of the application fee that was refunded.
...
class ApplicationFeeRefund extends ApiResource {
	...
	/**
	 * @return string the API URL for this Stripe\StripeTaxForWooCommerce\SDK\lib refund
	 */

...
namespace Stripe\StripeTaxForWooCommerce\SDK\lib\Checkout;
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $after_expiration When set, provides configuration for actions to take if this Checkout Session expires.
 ...
 * @property null|string $client_secret Client secret to be used when initializing Stripe\StripeTaxForWooCommerce\SDK\lib.js embedded checkout.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $consent Results of <code>consent_collection</code> for this session.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $consent_collection When set, provides configuration for the Checkout Session to gather active consent from customers.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property null|string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $currency_conversion Currency conversion details for automatic currency conversion sessions
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject[] $custom_fields Collect additional information from your customer using custom fields. Up to 2 fields are supported.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $custom_text
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Customer $customer The ID of the customer for this Session. For Checkout Sessions in <code>subscription</code> mode or Checkout Sessions with <code>customer_creation</code> set as <code>always</code> in <code>payment</code> mode, Checkout will create a new customer object based on information provided during the payment flow unless an existing customer was provided when the Session was created.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $customer_details The customer details including the customer's tax exempt status and the customer's tax IDs. Only the customer's email is present on Sessions in <code>setup</code> mode.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Invoice $invoice ID of the invoice created by the Checkout Session, if it exists.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $invoice_creation Details on the state of invoice creation for the Checkout Session.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\LineItem> $line_items The line items purchased by the customer.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentIntent $payment_intent The ID of the PaymentIntent for Checkout Sessions in <code>payment</code> mode.
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\PaymentLink $payment_link The ID of the Payment Link that created this Session.
 * @property null|string $payment_method_collection Configure whether a Checkout Session should collect a payment method.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $payment_method_configuration_details Information about the payment method configuration used for this Checkout session if using dynamic payment methods.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $payment_method_options Payment-method-specific configuration for the PaymentIntent or SetupIntent of this CheckoutSession.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $phone_number_collection
 * @property null|string $recovered_from The ID of the original expired Checkout Session that triggered the recovery flow.
 * @property null|string $redirect_on_completion Applies to Checkout Sessions with <code>ui_mode: embedded</code>. By default, Stripe\StripeTaxForWooCommerce\SDK\lib will always redirect to your return_url after a successful confirmation. If you set <code>redirect_on_completion: 'if_required'</code>, then we will only redirect if your user chooses a redirect-based payment method.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\SetupIntent $setup_intent The ID of the SetupIntent for Checkout Sessions in <code>setup</code> mode.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $shipping_address_collection When set, provides configuration for Checkout to collect a shipping address from a customer.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $shipping_cost The details of the customer cost of shipping, including the customer chosen ShippingRate.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $shipping_details Shipping information for this Checkout Session.
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject[] $shipping_options The shipping rate options applied to this Session.
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\Subscription $subscription The ID of the subscription for Checkout Sessions in <code>subscription</code> mode.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $tax_id_collection
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $total_details Tax and discount details for the computed total amount.
 ...
 */
class Session extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Checkout\Session the expired session
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\LineItem> list of line items
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

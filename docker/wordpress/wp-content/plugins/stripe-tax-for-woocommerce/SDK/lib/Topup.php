...
/**
 * To top up your Stripe\StripeTaxForWooCommerce\SDK\lib balance, you create a top-up object. You can retrieve
 ...
 * @property null|string|\Stripe\StripeTaxForWooCommerce\SDK\lib\BalanceTransaction $balance_transaction ID of the balance transaction that describes the impact of this top-up on your account balance. May not be specified depending on status of top-up.
 * @property int $created Time at which the object was created. Measured in seconds since the Unix epoch.
 * @property string $currency Three-letter <a href="https://www.iso.org/iso-4217-currency-codes.html">ISO currency code</a>, in lowercase. Must be a <a href="https://stripe.com/docs/currencies">supported currency</a>.
 * @property null|string $description An arbitrary string attached to the object. Often useful for displaying to users.
 * @property null|int $expected_availability_date Date the funds are expected to arrive in your Stripe\StripeTaxForWooCommerce\SDK\lib account for payouts. This factors in delays like weekends or bank holidays. May not be specified depending on status of top-up.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\Source $source The source field is deprecated. It might not always be present in the API response.
...
class Topup extends ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Topup the canceled topup

...
namespace Stripe\StripeTaxForWooCommerce\SDK\lib\Tax;
 ...
 * @property \Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $customer_details
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\Tax\TransactionLineItem> $line_items The tax collected or refunded, by line item.
 ...
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $reversal If <code>type=reversal</code>, contains information about what was reversed.
 * @property null|\Stripe\StripeTaxForWooCommerce\SDK\lib\StripeObject $shipping_cost The shipping cost details for the transaction.
...
class Transaction extends \Stripe\StripeTaxForWooCommerce\SDK\lib\ApiResource {
	 ...
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Tax\Transaction the created transaction
	 ...
	 * @param null|array|string $opts
	 *
	 * @return \Stripe\StripeTaxForWooCommerce\SDK\lib\Collection<\Stripe\StripeTaxForWooCommerce\SDK\lib\Tax\TransactionLineItem> list of transaction line items
	 * @throws \Stripe\StripeTaxForWooCommerce\SDK\lib\Exception\ApiErrorException if the request fails
	 */

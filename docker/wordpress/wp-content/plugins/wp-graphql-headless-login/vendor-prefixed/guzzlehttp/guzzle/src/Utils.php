...
use WPGraphQL\Login\Vendor\GuzzleHttp\Handler\CurlHandler;
...
final class Utils
{
     ...
     *
     * @return callable(\WPGraphQL\Login\Vendor\Psr\Http\Message\RequestInterface, array): Promise\PromiseInterface Returns the best handler for the given system.
     *

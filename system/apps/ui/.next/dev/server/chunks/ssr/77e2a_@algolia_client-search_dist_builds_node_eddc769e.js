module.exports = [
"[project]/node_modules/.pnpm/@algolia+client-search@5.46.2/node_modules/@algolia/client-search/dist/builds/node.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$requester$2d$node$2d$http$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$requester$2d$node$2d$http$2f$dist$2f$requester$2e$http$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@algolia+requester-node-http@5.46.2/node_modules/@algolia/requester-node-http/dist/requester.http.js [app-ssr] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/.pnpm/@algolia+client-common@5.46.2/node_modules/@algolia/client-common/dist/common.js [app-ssr] (ecmascript)");
;
;
;
;
...
function getDefaultHosts(appId) {
    ...
    ].concat((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["shuffle"])([
        {
...
function createSearchClient({ appId: appIdOption, apiKey: apiKeyOption, authMode, algoliaAgents, ...options }) {
    const auth = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createAuth"])(appIdOption, apiKeyOption, authMode);
    const transporter = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createTransporter"])({
        hosts: getDefaultHosts(appIdOption),
        ...options,
        algoliaAgent: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["getAlgoliaAgent"])({
            algoliaAgents,
            client: "Search",
     ...
     */ waitForTask ({ indexName, taskID, maxRetries = 50, timeout = (retryCount)=>Math.min(retryCount * 200, 5e3) }, requestOptions) {
            let retryCount = 0;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createIterablePromise"])({
                func: ()=>this.getTask({
                        indexName,
                        taskID
                    }, requestOptions),
     ...
     */ async replaceAllObjects ({ indexName, objects, batchSize, scopes }, requestOptions) {
        ...
        async indexExists ({ indexName }) {
            try {
                ...
                if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] && error.status === 404) {
                    return false;
                }
                throw error;
            }
...
function searchClient(appId, apiKey, options) {
    ...
    return {
        ...createSearchClient({
            ...
            logger: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createNullLogger"])(),
            requester: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$requester$2d$node$2d$http$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$requester$2d$node$2d$http$2f$dist$2f$requester$2e$http$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createHttpRequester"])(),
            algoliaAgents: [
                {
                    segment: "Node.js",
            ...
            responsesCache: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createNullCache"])(),
            requestsCache: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createNullCache"])(),
            hostsCache: (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createMemoryCache"])(),
            ...options
        }),
        /**
     ...
     */ generateSecuredApiKey: ({ parentApiKey, restrictions = {} })=>{
            ...
            mergedRestrictions = Object.keys(mergedRestrictions).sort().reduce((acc, key)=>{
                acc[key] = mergedRestrictions[key];
                return acc;
            }, {});
            const queryParameters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serializeQueryParameters"])(mergedRestrictions);
            return Buffer.from((0, __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["createHmac"])("sha256", parentApiKey).update(queryParameters).digest("hex") + queryParameters).toString("base64");
        },
        /**
     ...
     */ async accountCopyIndex ({ sourceIndexName, destinationAppID, destinationApiKey, destinationIndexName, batchSize }, requestOptions) {
            const responses = [];
            if (this.appId === destinationAppID) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IndicesInSameAppError"]();
            }
            if (!await this.indexExists({
                indexName: sourceIndexName
            })) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IndexNotFoundError"](sourceIndexName);
            }
            ...
            if (await destinationClient.indexExists({
                indexName: destinationIndexName
            })) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f40$algolia$2b$client$2d$common$40$5$2e$46$2e$2$2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IndexAlreadyExistsError"](destinationIndexName);
            }
            responses.push(await destinationClient.setSettings({
                indexName: destinationIndexName,
                indexSettings: await this.getSettings({
                    indexName: sourceIndexName
                })
            }, requestOptions));
            await this.browseRules({
                ...
                async aggregator (response) {
                    responses.push(await destinationClient.saveRules({
                        indexName: destinationIndexName,
                        rules: response.hits
                    }, requestOptions));
                }
            ...
            await this.browseSynonyms({
                indexName: sourceIndexName,
                async aggregator (response) {
                    responses.push(await destinationClient.saveSynonyms({
                        indexName: destinationIndexName,
                        synonymHit: response.hits
                    }, requestOptions));
                }
            });
            await this.browseObjects({
                indexName: sourceIndexName,
                browseParams: batchSize ? {
                    hitsPerPage: batchSize
                } : void 0,
                async aggregator (response) {
                    responses.push(...await destinationClient.saveObjects({
                        indexName: destinationIndexName,
...
//# sourceMappingURL=77e2a_%40algolia_client-search_dist_builds_node_eddc769e.js.map
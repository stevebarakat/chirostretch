module.exports = [
"[project]/node_modules/@algolia/client-search/dist/builds/node.js [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function createSearchClient({ appId: appIdOption, apiKey: apiKeyOption, authMode, algoliaAgents, ...options }) {
     ...
     */ waitForTask ({ indexName, taskID, maxRetries = 50, timeout = (retryCount)=>Math.min(retryCount * 200, 5e3) }, requestOptions) {
            let retryCount = 0;
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createIterablePromise"])({
                func: ()=>this.getTask({
                        indexName,
                        taskID
                    }, requestOptions),
     ...
     */ async replaceAllObjects ({ indexName, objects, batchSize, scopes }, requestOptions) {
        ...
        async indexExists ({ indexName }) {
            try {
                ...
                if (error instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["ApiError"] && error.status === 404) {
                    return false;
                }
                throw error;
            }
...
function searchClient(appId, apiKey, options) {
     ...
     */ generateSecuredApiKey: ({ parentApiKey, restrictions = {} })=>{
            ...
            const queryParameters = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["serializeQueryParameters"])(mergedRestrictions);
     ...
     */ async accountCopyIndex ({ sourceIndexName, destinationAppID, destinationApiKey, destinationIndexName, batchSize }, requestOptions) {
            ...
            if (this.appId === destinationAppID) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IndicesInSameAppError"]();
            }
            if (!await this.indexExists({
                indexName: sourceIndexName
            })) {
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IndexNotFoundError"](sourceIndexName);
            }
            ...
            if (await destinationClient.indexExists({
                ...
                throw new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$algolia$2f$client$2d$common$2f$dist$2f$common$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["IndexAlreadyExistsError"](destinationIndexName);
            }
...
//# sourceMappingURL=node_modules_%40algolia_client-search_dist_builds_node_b22be3fe.js.map